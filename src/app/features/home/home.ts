...
export class Home {
  ...
  feedingDescription(
    ...
    if (
      ...
      details.push(
        `Esq. ${this.formatFeedingDuration(
          times.left,
        )}`,
      );
    }
    ...
    if (
      ...
      details.push(
        `Dir. ${this.formatFeedingDuration(
          times.right,
        )}`,
      );
    }
    ...
    if (
      ...
      details.push(
        `Sem lado ${this.formatFeedingDuration(
          times.unspecified,
        )}`,
      );
    }
    ...
    if (
      ...
      details.push(
        `Sem divisão ${this.formatFeedingDuration(
          times.untracked,
        )}`,
      );
    }
